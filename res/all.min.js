...
!function(t,a,n){"use strict";t.fn.paypal=function(e,o){if(!e)return this;if(!(o=t.extend({},t.fn.paypal.defaults,e.getRootProperty(J.SHOP),o)).id)return console.log("paypal.js: no Seller ID found"),this;if(!o.currency)return console.log("paypal.js: no currency found"),this;o.hasOwnProperty("handling")&&(o.handling=Math.abs("string"==typeof o.handling?parseFloat(o.handling):o.handling)),o.hasOwnProperty("discount")&&(o.discount=Math.min(Math.max(0,"string"==typeof o.discount?parseInt(o.discount):o.discount),99));var i,s,l,r,p,d,c,u,h,m,f,g,y,v,w,b,x,C,T,O,P,I,A=t(this).eq(0),q=A.data("lpp_ns"),F=t.fn.paypal.text,S=(o.id.replace("|","@"),o.curr_symbol[o.currency]||o.currency),R={cart:"shopping-cart",shortcut:"shopping-cart-shortcut",window:"cart-window",cont:"cont",summary:"summary",summaryTxt:"summary-txt",details:"details",newItems:"new-items",items:"items",pricing:"pricing",price:"price",itemTotal:"item-total",itemTotalAmount:"item-total-amount",reduction:"reduction",discountRate:"discount-rate",discountAmount:"discount-amount",total:"total",totalAmount:"total-amount",shipping:"shipping",shippingAmount:"shipping-amount",tax:"tax",taxAmount:"tax-amount",coupon:"coupon",redeem:"redeem",buttons:"buttons",item:"item",path:"path",file:"file",thumb:"thumb",title:"title",data:"data",options:"options",quantity:"quantity",discount:"discount",amount:"amount"},E={data:"paypal.cart.data",date:"paypal.cart.date",hash:"paypal.cart.hash",settingsHash:"paypal.cart.settingsHash",coupon:"paypal.cart.coupon"},_="paypal.cart.voidCs",M=function(t){return S+" "+t.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g,"$1,")},N=function(){if(LOCALSTORAGE)for(var t in E)localStorage.removeItem(E[t])},L=function(){return JSON.stringify([o.id,o.currency,o.options]).hashCode()},D=function(a){if(LOCALSTORAGE){var n,e,i=(new Date).getTime();if(e=localStorage.getItem(E.date)){if(i-parseInt(e)>o.expiry)return void N();localStorage.setItem(E.date,i)}if((e=localStorage.getItem(E.data))&&localStorage.getItem(E.hash)==e.hashCode()&&localStorage.getItem(E.settingsHash)==L()){var s;for(n=JSON.parse(e),s=0;s<n.length;s++)B(d,n[s]);K(!0),s&&rt(localStorage.getItem(E.coupon))}}et(!0),W(),t.isFunction(a)&&a.call(this)},U=function(a){var n,e={};return a=a.split("="),e.name=t("<textarea>",{html:a[0]}).text(),a.length>1&&(n=a[1].split("+"),e.amount=parseFloat(n[0]),n.length>1&&(e.shipping=parseFloat(n[1])||0,n.length>2?e.shipping2=parseFloat(n[2])||0:e.shipping2=e.shipping)),e},k=function(t){var a=[];t=t.split("::");for(var n=0;n<t.length;++n)t[n]&&t[n].indexOf("=")>0&&a.push(U(t[n]));return a},G=function(t){var a=t.find("."+R.options);return a.length?("SELECT"===a[0].nodeName&&(a=a.find("option:selected")),a.data("val")):(console.log("paypal.js: Can't find shop option!"),null)},j=function(a,n,e,o,i){if(!a||!n)return{};var s=t("<input>",{type:o||"text"}).appendTo(a);return s.prop("name",n).addClass(n),e&&s.val("string"==typeof e?e.stripQuote():e),i&&s.prop(i,!0),s},B=function(a,e){if(r.find("."+R.item).length>=99)return n.modal(t("<div>",{html:F.noMoreItems}),{autoFade:3e3,class:"warning small"}),-1;var i,s,l=t("<form>",{name:R.item,class:R.item+" clearfix",method:"post"});if(l.on("submit",function(a){return a.preventDefault(),t(this).trigger("update"),!1}),(s=t("<a>",{class:"button icon-cancel"}).appendTo(l)).on("click."+q,function(){t(this).parents("form").eq(0).remove(),et()}).on("selectstart",function(t){return t.preventDefault(),!1}),e.hasOwnProperty("path")&&e.hasOwnProperty("title")&&e.hasOwnProperty("options")){j(l,R.path,e.path,"hidden"),j(l,R.file,e.file,"hidden"),function(a,n,e){e&&a.append(t("<img>",{class:R.thumb,src:e})),a.append(t("<span>",{class:R.title,html:n}))}(l,e.title,(e.path?getRelativePath(o.relPath,e.path):o.rootPath+"/")+o.thumbsFolder+e.file),(s=function(a,n,e,o){var i=t(),s=function(t){return t.name+" = "+M(t.amount)+(t.shipping?" (+"+t.shipping.toFixed(2)+")":"")};if("string"==typeof e&&(e=k(e)),t.isArray(e)&&e.length>1){i=t("<select>",{name:n,class:n}).appendTo(a);for(var l,r=0;r<e.length;r++)l=e[r],i.append(t("<option>",{html:s(l),val:l.amount}).data("val",l));i[0].selectedIndex=o||0}else t.isArray(e)&&(e=e[0]),i=t("<span>",{class:n,html:s(e)}).data("val",e).appendTo(a);return i}(i=t("<div>",{class:R.data}).appendTo(l),R.options,e.options,e.selectedOption)).on("change",function(){t(this).parents("form").eq(0).trigger("update")}),i.append("&times;");var p=e.hasOwnProperty("quantityCap")?e.quantityCap:o.quantityCap;if(s=j(i,R.quantity,p?Math.min(p,e.quantity||1):e.quantity||1),e.hasOwnProperty("quantityCap")&&e.quantityCap>0&&s.data("quantityCap",e.quantityCap),!e.hasOwnProperty("quantityCap")&&1!==o.quantityCap||1!==e.quantityCap?s.on("change",function(){var a=t(this),e=t(this).data("quantityCap");typeof e===UNDEF&&(e=o.quantityCap),e>0&&parseInt(a.val())>e&&(n.modal(t("<div>",{html:F.maxNItems.replace("{0}",e)}),{autoFade:3e3,class:"warning small"}),a.val(e)),a.parents("form").eq(0).trigger("update")}):s.prop("disabled","disabled"),e.hasOwnProperty("discountRate")&&e.discountRate>0&&e.discountRate<=99&&i.append(t("<span>",{class:R.discount,text:"-"+e.discountRate+"%"})),i.append("="),i.append(t("<span>",{class:R.amount})),l.on("update."+q,function(){z(t(this)),et()}),null!==z(l))return a.append(l),l;console.log("paypal.js: Calculation error! Item skipped.")}else console.log('paypal.js: Can\'t add item. Required parameter "path", "title" or "options" missing.');return null},H=function(t){var a,n={},o=e.getPropertyObject(t,J.SHOP,!0);return o&&o.hasOwnProperty("options")&&"-"!==o.options&&(n={title:t[J.TITLE]||t[J.NAME]||"",path:e.getFolderPath(t),file:t[J.NAME],options:k(o.options)},o.hasOwnProperty("discountRate")&&(a=parseInt(o.discountRate))>0&&a<100&&(n.discountRate=a),o.hasOwnProperty("tax")&&(a=parseFloat(o.tax))>0&&(n.tax=a),o.hasOwnProperty("quantityCap")&&(a=parseInt(o.quantityCap))>0&&(n.quantityCap=a)),n},Q=function(){var a=0;return r.find("."+R.item).each(function(){a+=parseInt(t(this).find("."+R.quantity).val(),10)||1}),a},W=function(){var a=d.find("."+R.item),n=p.find("."+R.summaryTxt),e=a.length;if(n.empty(),e){for(var o=0;o<3&&!(o>=e);o++)n.append(t("<img>",{src:a.eq(o).find("img."+R.thumb).attr("src")}));e>3&&n.append(" +"+(e-3)+" "+F[e>4?"items":"item"]),d.hide(),p.show()}else p.hide()},$=function(){d.is(":hidden")&&(Y(),p.hide(),d.fadeIn(400))},V=function(){return r.find("."+R.item).length},Y=function(){c.find("."+R.item).each(function(){t(this).appendTo(d)}),c.empty().hide(),W()},z=function(t){var a,n,e,o=G(t),i=1,s=0;return o&&o.amount?((n=t.find("."+R.quantity)).length&&(i=parseInt(n.val(),10)||1),e=o.amount*i,(n=t.find("."+R.discount)).length&&(a=Math.abs(parseFloat(n.text())))&&(e*=1-a/100),t.data("amount",e),o.shipping&&(s+=o.shipping),o.shipping2&&i>1&&(s+=(i-1)*o.shipping2),t.data("shipping",s),t.find("."+R.amount).html(M(e))):console.log("paypal.js: Calculation error!"),e},K=function(a){var n=u.data("val");return(a||typeof n===UNDEF)&&(n=function(){var a,n,e=0,o=0;return r.find("."+R.item).each(function(){typeof(a=t(this).data("amount"))===UNDEF&&(a=z(t(this))),n=t(this).data("shipping"),e+=a,o+=n}),u.data("val",e),v.data("aggregate",o),e}()),n},X=function(){return g.data("val")||0},Z=function(t){if(m)if(typeof t!==UNDEF){var a=K()*t/100;g.data("val",t).text("-"+t+"%").toggle(t>0),y.data("val",a).html(M(a)),tt(t>0)}else f&&(f.val(""),LOCALSTORAGE&&localStorage.removeItem(E.coupon),i=null),g.data("val",0).empty().hide(),y.data("val",0).html(M(0)),tt(!1)},tt=function(t){m.find("."+R.data).toggle(typeof t===UNDEF||t)},at=function(){if(o.hasOwnProperty("discount")&&o.discount>0&&o.discount<100){var t=0,a=0,n=K();if(g.data("val",o.discount).text("-"+o.discount+"%"),o.hasOwnProperty("discountMinQuantity")&&o.discountMinQuantity>0&&(y.data("qmin",o.discountMinQuantity),a=o.discountMinQuantity),o.hasOwnProperty("discountMinAmount")&&o.discountMinAmount>0&&(y.data("amin",o.discountMinAmount),t=o.discountMinAmount),a&&Q()<a||t&&n<t)g.hide(),y.data("val",0).html(M(0)),tt(!1);else{var e=n*o.discount/100;g.show(),y.data("val",e).html(M(e)),tt(e>0)}}else m&&(f&&(f.val(""),LOCALSTORAGE&&localStorage.removeItem(E.coupon),i=null),g&&g.data("val",0).empty().hide(),y.data("val",0).html(M(0)),tt(!1))},nt=function(t){if(m){var a=Math.min(K(),t);g&&g.data("val",0).empty().hide(),y.data("val",a).html(M(a)),tt(a>0)}},et=function(a){var e=V();c.toggle(!c.is(":empty")),p.toggle(!(d.is(":empty")||d.is(":visible"))),O.add(P).toggleClass("disabled",0===e),a&&!dt()&&at(),function(a){var e=0,i=Q(),s=K(a),l=v.data("aggregate")||0,r=o.handling||0;h.html(M(s)),m&&((e=y.data("qmin"))&&e>i?(e=0,dt()?(n.modal(t("<div>",{html:F.couponRemoved+" "+F.addMoreItems.replace("{0}",e-i)}),{autoFade:3e3,class:"warning small"}),st()):tt(!1)):(e=y.data("amin"))&&e>s?(e=0,dt()?(n.modal(t("<div>",{html:F.couponRemoved+" "+F.validAbove.replace("{0}",M(e))}),{autoFade:3e3,class:"warning small"}),st()):tt(!1)):g&&(e=g.data("val"))&&e>0?(e=s*e/100,y.data("val",e).html(M(e)),tt(!0)):(e=y.data("val"))&&e>0?(g&&g.hide(),e>s?(n.modal(t("<div>",{html:F.couponRemoved+" "+F.amountLowerThan.replace("{0}",M(e))}),{autoFade:3e3,class:"warning small"}),e=0,st()):tt()):tt(!1)),r||l>0?(v.show().data("val",Math.max(0,r+l)),w.html(M(r+l))):v.hide(),s+=r+l-e,x.data("netval",s),o.tax&&(T.html(M(s*o.tax/100)),s+=s*o.tax/100),x.html(M(s))}(!0),ot(e),!s.is(":visible")&&e&&I.fadeIn(400),a||function(a){if(LOCALSTORAGE){var n,e=[];s.find("."+R.item).each(function(){n=function(a){var n,e,i={};return(n=a.find("."+R.title)).length&&(i.title=n.text()),(n=a.find("."+R.path)).length&&(i.path=n.val()),(n=a.find("."+R.thumb).eq(0)).length&&(i.file=n.attr("src").getFile()),(n=a.find("."+R.options).eq(0)).length&&("SELECT"===n[0].nodeName?(e=[],n.find("option").each(function(){e.push(t(this).data("val"))}),n[0].selectedIndex>0&&(i.selectedOption=n[0].selectedIndex)):e=n.data("val"),e!==o.options&&(i.options=e)),(n=a.find("."+R.discount)).length&&(i.discountRate=Math.abs(parseFloat(n.text()))),(n=a.find("."+R.quantity)).length&&(i.quantity=parseInt(n.val())||1,(e=n.data("quantityCap"))&&(i.quantityCap=e)),i}(t(this)),isEmpty(n)||e.push(n)}),e.length?(e=JSON.stringify(e),localStorage.setItem(E.data,e),localStorage.setItem(E.date,(new Date).getTime()),localStorage.setItem(E.hash,e.hashCode()),localStorage.setItem(E.settingsHash,L()),f&&(n=pt())?localStorage.setItem(E.coupon,n):localStorage.removeItem(E.coupon)):N()}t.isFunction(a)&&a.call(this)}()},ot=function(t){t=typeof t===UNDEF?V():t,I.find(".button").text(" "+F.viewCart+(t>0?" ("+t+")":""))},it=function(){f&&(i&&i.hasOwnProperty("code")?f.val(i.code):f.val(""))},st=function(){f&&(f.val(""),i={},at())},lt=function(){var t;f&&(t=pt())?((i={}).code=t,(t=g.data("val"))&&(i.rate=t),(t=y.data("val"))&&(i.amount=t),(t=y.data("qmin"))&&(i.qmin=t),(t=y.data("amin"))&&(i.amin=t)):i=null},rt=function(t){t&&t.length&&f&&(f.val(t),ut(!1))},pt=function(){return f?f.val().trim():""},dt=function(){return f&&f.val().trim().length>0},ct=function(t){if(LOCALSTORAGE){var a=localStorage.getItem(_);return a&&(t==a||a.indexOf("::")&&a.match(new RegExp("^"+t+"::|::"+t+"::|::"+t+"$")))}return!1},ut=function(a){var e;if(f&&(e=pt())){if(i&&i.hasOwnProperty("code")&&i.code===e)return!0;for(var s,l,r,p,d,c,u=new Date,h=K(),m=Q(),g=xDecrypt(o.coupons).split("::"),v=function(t){var a=t.split(/-|:|\//);return a.length<2&&(a[1]=1),a.length<3&&(a[2]=1),new Date(parseInt(a[0]),parseInt(a[1]),parseInt(a[2]))},w=0;w<g.length;w++)if((s=g[w].split(/=|\s/))[0]===e&&s.length>1){if("NaN"==typeof(l=parseFloat(s[1]))||l<.01)continue;r="%"===s[1].charAt(s[1].length-1),p=0,d=0,c=0;for(var b=2;b<s.length;b++)s[b].match(/<\d+([-|\:|\/]\d+[-|\:|\/]\d+[-|\:|\/])*/)?p=v(s[b].substring(1)):s[b].match(/\d+\.\d+\+/)?c=parseFloat(s[b]):s[b].match(/\d+\+/)&&(d=parseInt(s[b],10)||0);if(p&&p<u)a?n.modal(t("<div>",{html:F.expired.replace("{0}",e)}),{autoFade:3e3,class:"alert small"}):console.log('Coupon "'+e+'" has expired!'),it();else if(c&&h<c)a?n.modal(t("<div>",{html:F.minAmountWarning.replace("{0}",M(c))}),{autoFade:3e3,class:"warning small"}):console.log('Coupon "'+e+'" can only be used if the item total amount is at least '+M(c)),it();else if(d&&m<d)a?n.modal(t("<div>",{html:F.minQuantityWarning.replace("{0}",d)}),{autoFade:3e3,class:"warning small"}):console.log('Coupon "'+e+'" can only be used if there is at least '+d+" items in the cart!"),it();else if(r){if(l>99||l<1)continue;(x=X())>l?(a?n.modal(t("<div>",{html:F.lowerThanCurrent.replace("{0}",x+"%")}),{autoFade:3e3,class:"warning small"}):console.log('Coupon "'+e+'" provides lower discount than current!'),it()):(a&&n.modal(t("<div>",{html:F.couponAccepted.replace("{0}",l+"%")}),{autoFade:3e3,title:F.success,class:"success small"}),Z(l),y.data({amin:c,qmin:d}),lt(),et())}else if(ct(e))a?n.modal(t("<div>",{html:F.reclaimed}),{autoFade:3e3,class:"warning small"}):console.log('Coupon "'+e+'" has been reclaimed previously.'),it();else{var x=X(),C=x>0?h*x/100:0;h<l?(a?n.modal(t("<div>",{html:F.higherThanTotal.replace("{0}",M(l))}),{autoFade:3e3,class:"warning small"}):console.log('Coupon "'+e+'" provides higher discount that the total amount!'),it()):C>l?(a?n.modal(t("<div>",{html:F.lowerThanCurrent.replace("{0}",M(C))}),{autoFade:3e3,class:"warning small"}):console.log('Coupon "'+e+'" offers less discount than the current!'),nt(l),y.data({amin:c,qmin:d}),lt(),et()):(a&&n.modal(t("<div>",{html:F.couponAccepted.replace("{0}",M(l))}),{autoFade:3e3,title:F.success,class:"success small"}),nt(l),y.data({amin:c,qmin:d}),lt(),et())}return!0}return n.modal(t("<div>",{html:F.noSuch}),{autoFade:3e3,class:"alert small"}),it(),!1}return!0},ht=function(){var n=t("<form>",{class:"hide",method:"post",action:(DEBUG?o.sandboxurl:o.url)+"cgi-bin/webscr"}).appendTo(r),e=r.find("."+R.item),i=function(a,e){n.append(t("<input>",{type:"hidden",name:a,val:e}))};if(e.length){if(o.sameWindowCheckout||n.attr("target",o.target),i("cmd","_cart"),i("charset","utf-8"),i("lc",o.locale),i("upload","1"),i("business",o.id.replace("|","@")),i("currency_code",o.currency),o.hasOwnProperty("successUrl")&&i("return",o.successUrl.fixjAlbumPaths(o.resPath,o.rootPath,o.relPath)),o.hasOwnProperty("handling")&&o.handling>0&&i("handling_cart",o.handling),e.each(function(a){var n=function(t){var a,n,e={};return(a=t.find("."+R.title)).length&&(e.title=a.text()),(a=t.find("."+R.path)).length&&(e.path=a.val()),(a=t.find("."+R.file)).length&&(e.file=a.val()),(n=G(t))&&(n.hasOwnProperty("name")&&(e.option=n.name),n.hasOwnProperty("amount")&&(e.amount=n.amount),n.hasOwnProperty("shipping")&&(e.shipping=n.shipping),n.hasOwnProperty("shipping2")&&(e.shipping2=n.shipping2)),(a=t.find("."+R.quantity)).length&&(e.quantity=a.val()),(a=t.find("."+R.discount)).length&&(e.discount=Math.abs(parseInt(a.text(),10))),(a=t.find("."+R.tax)).length&&(e.tax=a.val()),e}(t(this)),e=String(a+1),o=[n.path,n.file].join("/");i("item_name_"+e,"("+o+") "+(n.title!==n.file?n.title+" :: ":" ")+n.option),n.hasOwnProperty("discount")&&n.discount>0?i("amount_"+e,(n.amount*(1-n.discount/100)).toFixed(2)):i("amount_"+e,n.amount.toFixed(2)),n.hasOwnProperty("quantity")&&n.quantity>1&&i("quantity_"+e,n.quantity),n.hasOwnProperty("shipping")&&n.shipping>0&&(i("shipping_"+e,n.shipping),n.hasOwnProperty("shipping2")?n.shipping2>0&&i("shipping2_"+e,n.shipping2):i("shipping2_"+e,n.shipping)),n.hasOwnProperty("tax")&&n.tax>0&&i("tax_"+e,n.tax)}),n.append(t("<input>",{type:"submit",val:"PayPal"})),!m||ut(!1)){if(m){var s=g.data("val");if(s){var l=K(),p=y.data("amin"),d=Q(),c=y.data("qmin");(!p&&!c||!c&&l>=p||!p&&d>=c||l>=p&&d>=c)&&i("discount_rate_cart",s)}else(s=y.data("val"))&&(i("discount_amount_cart",s),f&&function(t){if(LOCALSTORAGE){var a=localStorage.getItem(_);if(a&&a.length){if(!t||t==a||a.indexOf("::")&&a.match(new RegExp("^"+t+"::|::"+t+"::|::"+t+"$")))return;localStorage.setItem(_,a+"::"+t)}else t&&localStorage.setItem(_,t)}}(f.find("input").val()))}if(o.tax>0){var u=x.data("netval");u&&o.tax&&i("tax_cart",(u*o.tax/100).toFixed(2))}if(DEBUG&&console.log((n.html()+"").replace(/></g,">\n<")),!o.sameWindowCheckout){var h=Math.min(a.width()-80,1024),v=Math.min(a.height()-80,800);window.open("",o.target,"width="+h+",height="+v+",left=40,top=40,location=no,scrollbars=yes,resizable=yes,menubar=no,toolbar=no,directories=no,status=no,copyhistory=no")}n.trigger("submit"),e.remove(),et(),gt()}}else buyNow.addClass("disabled")},mt=function(){n.modal(t("<h3>",{class:"text-center icon-warning",html:" "+F.removeAllItems}),[{t:F.yes,c:"alert icon-trash",h:function(){r.find(".item").remove(),et(),gt()}},{t:F.no,h:function(){}}],{class:"alert small"})},ft=function(a){s.is(":visible")||(n.addClass("no-scroll"),n.addClass("has-modal"),s.fadeIn(400,function(){t.isFunction(a)&&a.call(this)})),I.fadeOut()},gt=function(a){var n=Q();s.is(":visible")&&(t("body,html").removeClass("no-scroll"),t("body").removeClass("has-modal"),s.fadeOut(400,function(){n>=0&&I.fadeIn(400),t.isFunction(a)&&a.call(this)}))};return o.hasOwnProperty("options")||(o.options=e.getRootProperty("shopOptionsGlobal")),"string"==typeof o.options&&(o.options=k(o.options)),function(a){void 0!==q&&(t(l).off("."+q),t("#cart_"+q).remove(),t("#cart_shortcut_"+q).remove()),A.data("lpp_ns",q="lpp_"+Math.floor(1e4*Math.random())),s=t("<div>",{id:"cart_"+q,class:"modal "+R.cart,role:"modal"}).hide().appendTo(n),o.useFloatButton&&(I=t("<div>",{id:"cart_shortcut_"+q,class:R.shortcut}).hide().append(t("<a>",{class:"small button icon-shopping-cart"}).on("click."+q,ft)).appendTo(A)),(l=t("<div>",{class:"window has-header "+R.window,role:"dialog"}).appendTo(s)).append(t("<header>",{class:"icon-shopping-cart",html:"<strong> "+F.shoppingCart+"</strong>"})),l.append(t("<a>",{class:"btn close"}).on("click."+q,gt)),s.on("click."+q,function(t){return t.target.id!=="cart_"+q||(gt(),!1)}),r=t("<div>",{class:"content"}).appendTo(l),(p=t("<div>",{class:R.summary+" clearfix"}).hide().appendTo(r)).append(t("<div>",{class:R.summaryTxt})),p.append(t("<a>",{class:"details-btn icon-drop-down",text:" "+F.edit}).on("click."+q,$)),d=t("<div>",{class:R.details+" "+R.items}).hide().appendTo(r),c=t("<div>",{class:R.newItems+" "+R.items}).appendTo(r);var e=t("<div>",{class:R.pricing}).appendTo(r);if(u=t("<div>",{class:R.itemTotal,text:F.subtotal+": "}).appendTo(e),h=t("<span>",{class:R.itemTotalAmount+" "+R.amount}).appendTo(u),o.coupons||o.discount){if(m=t("<div>",{class:R.reduction+" clearfix"}).appendTo(e),o.coupons){var i=t("<form>",{class:R.coupon}).appendTo(m);i.append(t("<a>",{class:"button icon-cancel"}).on("click."+q,function(){st(),et()})),f=t("<input>",{type:"text",placeholder:F.couponCode}).appendTo(i),i.append(t("<a>",{class:"secondary button icon-refresh"}).on("click",function(){ut(!0)})),i.on("submit",function(){return ut(!0),!1}),f.on("blur",function(){ut(!0)}),f.prev().addTooltip(F.remove)}m.append(t("<div>",{class:R.data,text:F.discount}).append(g=t("<span>",{class:R.discount+" "+R.discountRate})).append(": &ndash;").append(y=t("<span>",{class:R.discountAmount+" "+R.amount})))}v=t("<div>",{class:R.shipping,text:F.shippingAndHandling+": +"}).appendTo(e),w=t("<span>",{class:R.shippingAmount+" "+R.amount}).appendTo(v),o.tax&&(C=t("<div>",{class:R.tax,text:F.tax+" ("+o.tax+"%): +"}).appendTo(e),T=t("<span>",{class:R.taxAmount+" "+R.amount}).appendTo(C)),b=t("<div>",{class:R.total,text:F.total+": "}).appendTo(e),x=t("<span>",{class:R.totalAmount+" "+R.amount}).appendTo(b);var S=t("<div>",{class:R.buttons}).appendTo(r);S.append(t("<a>",{class:"secondary button icon-arrow-left",text:" "+F.continueShopping}).on("click."+q,gt)),P=t("<a>",{class:"alert button icon-trash",text:" "+F.emptyCart}).on("click."+q,mt).appendTo(S),O=t("<a>",{class:"disabled button icon-paypal",html:" "+F.buyNow}).on("click."+q,ht).appendTo(S),S.append(t("<p>",{class:"fineprint",text:F.processedByPaypal})),o.hasOwnProperty("instructions")&&r.append(t("<div>",{class:"instructions icon-info"}).append(t("<div>").append(o.instructions.fixjAlbumPaths(o.resPath,o.rootPath,o.relPath)))),at(),l.find("a.close").addTooltip(F.continueShopping),D()}(),A.on("addItems",function(a){!function(a){if(a&&a.length){if(t.isArray(a)){a.length>1&&Y();for(var n=0;n<a.length&&-1!==B(c,H(a[n]));n++);}else B(c,H(a));et(),ft()}}(Array.prototype.slice.call(arguments,1))}).on("emptyCart",mt).on("showCart",ft).on("hideCart",gt),o.hasOwnProperty("onReady")&&o.onReady(this),this},t.fn.paypal.defaults={currency:"EUR",locale:"US",quantityCap:0,expiry:36e5,shippingFlat:!1,sameWindowChekout:!1,useFloatButton:!0,target:"BuyNow",rootPath:"",relPath:"",thumbsFolder:"thumbs/",url:"https://www.paypal.com/",sandboxurl:"https://www.sandbox.paypal.com/",curr_symbol:{USD:"US$",EUR:"&euro;",GBP:"GB&pound;",JPY:"&yen;",HUF:"Ft"}},t.fn.paypal.text=getTranslations({addCart:"Add to Cart",shoppingCart:"Shopping cart",edit:"Edit",continueShopping:"Continue shopping",buyNow:"Buy Now",closeWindow:"Close window",viewCart:"View Cart",emptyCart:"Empty Cart",removeAllItems:"Remove all items?",yes:"Yes",no:"No",processedByPaypal:"Payment processed by PayPal",item:"item",items:"items",success:"Success",couponCode:"Coupon code",redeem:"Redeem",noSuch:"No such coupon exists!",expired:"The coupon code <b>{0}</b> has expired!",lowerThanCurrent:"This coupon offers lower discount than the current <b>{0}</b>.",reclaimed:"This coupon has already been used!",subtotal:"Subtotal",shippingAndHandling:"Shipping and handling",reduction:"Reduction",discount:"Discount",total:"Total",tax:"Tax",remove:"Remove",couponAccepted:"Coupon code accepted, discounting <b>{0}</b>.",couponRemoved:"Coupon has been removed.",amountLowerThan:"The amount is lower than the discount <b>{0}</b>.",addMoreItems:"Add {0} more item(s) to use this coupon!",validAbove:"Valid only above {0} cart value.",higherThanTotal:"Coupon provides higher discount (<b>{0}</b>) than the cart total.",minAmountWarning:"This coupon can only be used if the total amount exceeds <b>{0}</b>.",minQuantityWarning:"This coupon can only be used if the number of items exceeds <b>{0}</b>.",maxNItems:"Maximum <b>{0}</b> items allowed!"})}(jQuery,$(window),$("body"));
