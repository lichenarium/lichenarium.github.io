...
var VER='2.14.5',DEBUG=false,LOCALE='en-US';
...
!function(e,t,a){"use strict";e.fn.feedback=function(t,n){if(!t)return this;if(!(n=e.extend({},e.fn.feedback.defaults,t.getRootProperty(J.FEEDBACK),n)).to)return console.log("feedback.js: no target email found"),this;var i,o,s,r,l,c,d=e(this).eq(0),f=d.data("lfb_ns"),m=e.fn.feedback.text,p=xDecrypt(n.to),u="%0D%0A",h=e(),b=e(),g=e(),v={cart:"feedback-cart",shortcut:"feedback-shortcut",window:"feedback-window",cont:"cont",beforeItems:"before-items",summary:"summary",summaryTxt:"summary-txt",details:"details",newItems:"new-items",items:"items",afterItems:"after-items",buttons:"buttons",item:"item",path:"path",file:"file",info:"info",thumb:"thumb",title:"title",data:"data",options:"options"},y={data:"feedback.cart.data",date:"feedback.cart.date"},w=DIR_PATH||"/",C=function(e,t){localStorage.setItem(w+e,t)},T=function(e){return localStorage.getItem(w+e)},I=function(e){localStorage.removeItem(w+e)},k=function(){if(LOCALSTORAGE)for(var e in y)I(y[e])},x=function(t){if(LOCALSTORAGE){var a,n={};(a=o.find("."+v.beforeItems+" form")).length&&(n.before=a.serialize()),(a=o.find("."+v.item)).length&&(n.items=new Array,a.each(function(){var t=e(this);n.items.push({path:t.data("path"),file:t.data("file"),title:t.find("."+v.title).text(),data:t.find("."+v.data+" form").serialize()})})),(a=o.find("."+v.afterItems+" form")).length&&(n.after=a.serialize()),isEmpty(n)?k():(n=JSON.stringify(n),C(y.data,n),C(y.date,(new Date).getTime()))}typeof t===FUNCTION&&t.call(this)},S=function(a,o,s,r){if(o){var c,d,m=a?getRelativePath(n.relPath||"/",a):n.rootPath+"/";return c=e("<div>",{class:v.item+" clearfix"}),(d=e("<div>",{class:v.info}).appendTo(c)).append(e("<a>",{class:"button icon-cancel"}).on("click."+f,function(){e(this).parents("."+v.item).remove()}).on("selectstart",function(e){return e.preventDefault(),!1})),d.append(e("<img>",{class:v.thumb,src:m+n.thumbsFolder+"/"+o})),d.append(e("<span>",{class:v.title,html:s})),c.append(e("<div>",{class:v.data,html:t.processTemplate(i)})),l.append(c),r&&c.find("form").deserialize(r,!0),c.data({path:a,file:o}),c}},N=function(e){return S(t.getFolderPath(e),t.getThumbPath(e).getFile(),e[J.TITLE]||e[J.NAME]||"")},A=function(e){var t=F();if(e&&e.length){if(Array.isArray(e))for(var a=0;a<e.length;a++)N(e[a]);else N(e);O(),j(function(){l.find("."+v.item).eq(t).find("input,textarea,select")[0].focus()})}},F=function(){return r.find("."+v.item).length},O=function(e){var t=F();b.add(h).add(g).toggleClass("disabled",0===t),B(t),!o.is(":visible")&&t&&c.fadeIn(400),e||x()},B=function(e,t){typeof t!==UNDEF&&t?c.find(".button").removeClass("view-cart").addClass("add-cart pop").html("<sup>+</sup> "+m.addComment+" <b>"+t+"</b>"):(e=0===t||typeof e===UNDEF?F():e,c.find(".button").removeClass("add-cart pop").addClass("view-cart").html(" "+m.viewFeedbackCart+(e>0?" <b>"+e+"</b>":"")))},U=function(t){if(t){var a,n=[];return t.find("input,textarea,select").each(function(){null!==(a=e(this).val())&&n.push((this.name||this.id||this.nodeName)+": "+a)}),n.join(", ")}return""},E=function(e){if(e)switch(n.formatting){case"human":return e.serialize().replace(/\+/g,"%20").replace(/=/g,": ").replace(/\&/g,u);case"serialized":return(e.attr("name")||e.attr("id")||"form")+'="'+e.serialize().replace(/%22/g,"\\%22").replace(/%0D(%0A)?/,"\\n")+'";';default:return encodeURIComponent(U(e))}return""},R=function(){var e;return(e=r.find("."+v.beforeItems+" form")).length?E(e):""},P=function(){var t=[];return"serialized"===n.formatting?t.push("items={"):t.push(u+"----------------------"),r.find("."+v.item).each(function(a){var i=e(this),o=i.data("path")+"/"+i.data("file"),s=i.find("form").eq(0);switch(n.formatting){case"human":t.push((a?u:"")+String(a+1)+".%09"+o.replace(/%2([\da-f])/gi,"%252$1")+(s?u+"%09"+s.serialize().replace(/\+/g,"%20").replace(/=/g,": ").replace(/\&/g,",%20"):""));break;case"serialized":t.push('{file:"'+o.replace(/%2([\da-f])/gi,"%252$1")+'"'+(s?","+(s.attr("name")||s.attr("id")||"form")+':"'+i.find("form").serialize().replace(/%22/g,"\\%22").replace(/%0D(%0A)?/,"\\n")+'"':"")+"},");break;default:t.push(String(a+1)+".%09"+o.replace(/%2([\da-f])/g,"%252$1")+(s?":%09"+encodeURIComponent(U(s)):""))}}),"serialized"===n.formatting?(t[t.length-1]=t[t.length-1].replace(/\,$/,""),t.push("};")):t.push("----------------------"+u),t.join(u)},z=function(){var e;return(e=r.find("."+v.afterItems+" form")).length?E(e):""},D=function(t){var n=R()+u+P()+u+z(),i=(UNDEF,e("<div>",{html:(t?'<h4 class="icon-warning">'+m.tooLong+"</h4>":"")+'<p><textarea name="body" rows="8">'+m.to+": "+p+"\n"+m.subject+": "+s.find("header").text()+"\n\n"+decodeURIComponent(n)+'</textarea></p><p class="icon-info instructions"> '+m.copyInstructions+"</p>"}));a.modal(i,[{t:m.okButton,c:"icon-ok",h:function(){_()}}],{title:t?m.warning:m.copiedToClipboard,class:(t?"warning":"success")+" small"}),i.find("[name=body]")[0].select(),document.execCommand("copy")},L=function(){var e,t="mailto:"+encodeURIComponent(p)+"?subject="+encodeURIComponent(s.find("header").text()),a=R()+u+P()+u+z();if(DEBUG)try{console.log(decodeURIComponent(a))}catch(e){console.log(e)}(e=t+"&body="+a).length>2048?D(!0):(window.location.href=e,_()),$()},_=function(){a.modal(e("<h3>",{class:"text-center icon-warning",html:" "+m.removeAllItems}),[{t:m.yes,c:"alert icon-trash",h:function(){r.find(".item").remove(),O(),$()}},{t:m.no,h:function(){}}],{class:"alert small"})},j=function(e){o.is(":visible")||(a.addClass("no-scroll"),a.addClass("has-modal"),o.fadeIn(400,function(){typeof e===FUNCTION&&e.call(this),r.animate({scrollTop:r[0].scrollHeight-Math.round(r.outerHeight())},400)})),c.fadeOut()},$=function(t){F();o.is(":visible")&&(e("body,html").removeClass("no-scroll"),e("body").removeClass("has-modal"),o.fadeOut(400,function(){c.fadeIn(400),typeof t===FUNCTION&&t.call(this)}),x())};return function(p){var u,y;void 0!==f&&(e(s).off("."+f),e("#cart_"+f).remove(),e("#cart_shortcut_"+f).remove()),d.data("lfb_ns",f="lfb_"+Math.floor(1e4*Math.random())),o=e("<div>",{id:"cart_"+f,class:"modal "+v.cart,role:"modal"}).hide().appendTo(a),n.useFloatButton&&(c=e("<div>",{id:"cart_shortcut_"+f,class:v.shortcut}).append(e("<a>",{class:"small button icon-email view-cart"}).on("click."+f,function(){e(this).hasClass("view-cart")?j():typeof n.getSelected===FUNCTION&&(A(n.getSelected.call()),typeof n.selectNone===FUNCTION&&n.selectNone.call())})).appendTo(d)),(s=e("<div>",{class:"window has-header "+v.window,role:"dialog"}).appendTo(o)).append(e("<header>",{class:"icon-email",html:"<strong> "+m.feedbackOnAlbum.template(t.getAlbumTitle())+"</strong>"})),s.append(e("<a>",{class:"btn close"}).on("click."+f,$)),o.on("click."+f,function(e){return e.target.id!=="cart_"+f||($(),!1)}),r=e("<div>",{class:"content"}).appendTo(s),(u=n.template.split(n.itemsStart)[0].trim())&&r.append(e("<div>",{class:v.beforeItems,html:t.processTemplate(u)})),l=e("<div>",{class:v.items}).appendTo(r),(u=n.template.split(n.itemsStop)).length&&(u=u[1].trim())&&r.append(e("<div>",{class:v.afterItems,html:t.processTemplate(u)})),(y=e("<div>",{class:v.buttons}).appendTo(r)).append(e("<a>",{class:"secondary button icon-arrow-left",text:" "+m.continueBrowsing}).on("click."+f,$)),g=e("<a>",{class:"alert button icon-trash",text:" "+m.removeAll}).on("click."+f,_).appendTo(y),h=e("<a>",{class:"success disabled button icon-external",html:" "+n.copyBtnLabel}).on("click."+f,function(){return D(!1),!1}).appendTo(y),n.useSendButton&&(b=e("<a>",{class:"disabled button icon-email",html:" "+n.sendBtnLabel}).on("click."+f,L).appendTo(y),y.append(e("<p>",{class:"fineprint",html:m.feedbackButtonExplanation}))),n.hasOwnProperty("instructions")&&n.instructions&&r.append(e("<div>",{class:"instructions icon-info"}).append(e("<div>").append(n.instructions.fixjAlbumPaths(n.resPath,n.rootPath,n.relPath)))),s.find("a.close").addTooltip(m.continueBrowsing),n.template.indexOf(n.itemsStart)>=0&&(u=n.template.split(n.itemsStart)[1].trim())&&(u=u.split(n.itemsStop)[0].trim())&&(i=u.replace(/\$\{fileName\}/g,"${name}")),typeof p===FUNCTION&&p.call(this)}(function(e){if(LOCALSTORAGE){var t,a=(new Date).getTime();if(t=T(y.date)){if(a-parseInt(t)>n.expiry)return void k();C(y.date,a)}if(t=T(y.data)){var i=JSON.parse(t);if(!isEmpty(i)){if(i.before&&o.find("."+v.beforeItems+" form").deserialize(i.before),i.items)for(var s=0;s<i.items.length;s++)S(i.items[s].path,i.items[s].file,i.items[s].title,i.items[s].data);i.after&&o.find("."+v.afterItems+" form").deserialize(i.after)}}}O(!0),typeof e===FUNCTION&&e.call(this)}),d.on("addItems",function(e){var t=Array.prototype.slice.call(arguments,1);A(t)}).on("emptyCart",function(e,t){_(t)}).on("itemsSelected",function(e,t){!function(e){B(0,e),c.fadeIn(400)}(t)}).on("showCart",function(e,t){j(t)}).on("hideCart",function(e,t){$(t)}),n.hasOwnProperty("onReady")&&n.onReady(this),this},e.fn.feedback.defaults={expiry:36e5,useFloatButton:!0,rootPath:"",relPath:"",formatting:"human",thumbsFolder:"thumbs/",copyBtnLabel:"Copy to clipboard",sendBtnLabel:"Send feedback",useSendButton:!0,itemsStart:"\x3c!-- items:start --\x3e",itemsStop:"\x3c!-- items:stop --\x3e"},e.fn.feedback.text=getTranslations({edit:"Edit",continueBrowsing:"Continue browsing",feedback:"Feedback",sendFeedback:"Send feedback",addComment:"Add comment",viewFeedbackCart:"Feedback window",feedbackOnAlbum:'Feedback on album "{0}"',closeWindow:"Close window",removeAll:"Remove all",removeAllItems:"Remove all items?",yes:"Yes",no:"No",to:"To",subject:"Subject",warning:"Warning",copiedToClipboard:"Copied to clipboard!",okButton:"OK",tooLong:"This is too long to pass to the email application directly.",copyInstructions:'The text has been copied to your clipboard. Now switch to the email applicaiton or the webmail and paste it as message body. Move "To" and "Subject" into the appropriate boxes!',feedbackButtonExplanation:'Try "Send" if you have an email application installed, use "Copy" for web mail!'})}(jQuery,$(window),$("body"));
